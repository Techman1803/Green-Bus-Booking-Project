 ...
 * @author vigne
 */
public class GreenBusSystem extends javax.swing.JFrame {

    /**
     * Creates new form BookingSystem
     */
    public GreenBusSystem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GreenBus System");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GreenBusSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GreenBusSystem().setVisible(true);
            }
        });
    }
